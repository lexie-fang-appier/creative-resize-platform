 ...
 * needs (fileSizeBytes for the Taobao PSDs, a display filename for the Lotte AI
...
// ---------------------------------------------------------------------------
// CAM-406076 — Mox Bank, 8 real files (test_classifier.py Part B). Real
...
// ---------------------------------------------------------------------------
const moxBank: ScannedAsset[] = [
  { driveFileId: nextId(), filename: "MOX Invest-v1_300x250.jpg", mimeType: "image/jpeg", format: "JPG", width: 300, height: 250, fileSizeBytes: 82834, videoDurationSec: null, psdCanvasW: null, psdCanvasH: null, contentHash: null, isFlattened: true, hasMultipleArtboards: false, redesignEligible: null, scanError: null },
  { driveFileId: nextId(), filename: "MOX Invest-v1_300x600.jpg", mimeType: "image/jpeg", format: "JPG", width: 300, height: 600, fileSizeBytes: 148878, videoDurationSec: null, psdCanvasW: null, psdCanvasH: null, contentHash: null, isFlattened: true, hasMultipleArtboards: false, redesignEligible: null, scanError: null },
  { driveFileId: nextId(), filename: "MOX Invest-v1_300x300.jpg", mimeType: "image/jpeg", format: "JPG", width: 300, height: 300, fileSizeBytes: 93712, videoDurationSec: null, psdCanvasW: null, psdCanvasH: null, contentHash: null, isFlattened: true, hasMultipleArtboards: false, redesignEligible: null, scanError: null },
  { driveFileId: nextId(), filename: "MOX Invest-v1_320x320.jpg", mimeType: "image/jpeg", format: "JPG", width: 320, height: 320, fileSizeBytes: 105757, videoDurationSec: null, psdCanvasW: null, psdCanvasH: null, contentHash: null, isFlattened: true, hasMultipleArtboards: false, redesignEligible: null, scanError: null },
  { driveFileId: nextId(), filename: "MOXPlus_300x250.jpg", mimeType: "image/png", format: "PNG", width: 300, height: 250, fileSizeBytes: 60625, videoDurationSec: null, psdCanvasW: null, psdCanvasH: null, contentHash: null, isFlattened: true, hasMultipleArtboards: false, redesignEligible: null, scanError: null },
  { driveFileId: nextId(), filename: "MOXPlus_300x600.jpg", mimeType: "image/png", format: "PNG", width: 300, height: 600, fileSizeBytes: 92566, videoDurationSec: null, psdCanvasW: null, psdCanvasH: null, contentHash: null, isFlattened: true, hasMultipleArtboards: false, redesignEligible: null, scanError: null },
  { driveFileId: nextId(), filename: "MOXINVEST_PM_banner_300x600_v2.jpg", mimeType: "image/jpeg", format: "JPG", width: 300, height: 600, fileSizeBytes: 96051, videoDurationSec: null, psdCanvasW: null, psdCanvasH: null, contentHash: null, isFlattened: true, hasMultipleArtboards: false, redesignEligible: null, scanError: null },
  { driveFileId: nextId(), filename: "MOXINVEST_PM_banner_320x320_v2.jpg", mimeType: "image/jpeg", format: "JPG", width: 320, height: 320, fileSizeBytes: 65463, videoDurationSec: null, psdCanvasW: null, psdCanvasH: null, contentHash: null, isFlattened: true, hasMultipleArtboards: false, redesignEligible: null, scanError: null },
];

// ---------------------------------------------------------------------------
// CAM-405006 — Kakao bizboard vs Naver smart channel, same 2 files appearing
...
// ---------------------------------------------------------------------------
// Taobao (test_classifier.py Part E) — 4 real PSD canvas sizes from
...
// ---------------------------------------------------------------------------
// Lotte Bank .ai artboards (test_classifier.py Part E) — 9 real artboard
...
// ---------------------------------------------------------------------------
const lotteAiArtboards: ScannedAsset[] = [
  ...
  (ab): ScannedAsset => ({
    driveFileId: nextId(),
    filename: `lotte-bank-redesign.ai#artboard-${ab.idx}`,
...
// ---------------------------------------------------------------------------
// CAM-401655 — SofyBe, 2 real client-provided source videos (test_classifier.py
// Part D). Real width/height/duration/fileSizeBytes.
// ---------------------------------------------------------------------------
const sofybeVideo: ScannedAsset[] = [
